...
export default (props) => {
  ...
  return (
  <div style={{color: "black",  display: "flex", justifyContent: "space-between", alignItems: "flex-start", width: "20%", position: "absolute", top: "0px", right: "0px", fontSize: "20px", fontFamily: "'Playfair Display', serif",}}>
